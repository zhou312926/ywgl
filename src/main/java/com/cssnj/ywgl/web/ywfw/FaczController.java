 ...
 */
@Controller
@RequestMapping(value = "/ywfw/facz")
public class FaczController extends BaseController {

    @Autowired
    private IService faczService;
    @Autowired
    private IService ywDmService;

    private static final String PERMIT_VIEW = "facz:view";
    private static final String PERMIT_QUERY = "facz:query";
    ...
    public ModelAndView list(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        ModelAndView modelAndView = new ModelAndView("ywfw/facz/list");
    ...
    public JsonResponse loadList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return execute(jsonRequest, request, response, faczService, PERMIT_QUERY);
    }
    ...
    public ModelAndView wtxx_read(HttpServletRequest request, HttpServletResponse response, @Param("id") String id) throws Exception {
        checkPermission(PERMIT_QUERY);
        ModelAndView modelAndView = new ModelAndView("ywfw/facz/wtxx_read");
        modelAndView.getModel().put("wtlxList", ywDmService.execute(new JsonRequest("queryWtlxDm")).getData());
        modelAndView.getModel().put("yyxtList", ywDmService.execute(new JsonRequest("queryYyxtDm")).getData());
        ...
        JsonResponse<Map> jsonResponse = faczService.execute(jsonRequest);
